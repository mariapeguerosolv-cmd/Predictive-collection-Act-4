...
Herramienta de IA utilizada - ¿La usaste? - Prompt utilizado

**ChatGPT / OpenAI**	**☐ Sí**    ☐ No	

* “Mi Colaboratory no está leyendo este archivo”
...
**Copilot (Microsoft)** 	**☐ Sí**    ☐ No	

* “¿Debo descargar algo de Hugging Face o registrarme?”
...
_"Hello, good day. I have been experiencing some issues regarding the invoice. I am currently reviewing the matter with the internal team, and they have informed me that Accounts Payable is processing it and that it is currently pending approval from Laura."_
...
| Modelo          | Predicción | Confianza | Riesgo | Acción |
|-----------------|------------|-----------|--------|--------|
| DistilBERT      | negative   | 0.97      | -      |  -     |
| Twitter-RoBERTa | neutral    | 0.50      | -      |  -     |
| FinBERT         | negative   | 0.68      | -      |  -     |
| Pipeline Final  | negative   |  -        | high   | call   |
...
_"Hello, I will review with my AP team, thank you."_
...
| Modelo          | Predicción | Confianza | Riesgo | Acción    |
|-----------------|------------|-----------|--------|-----------|
| DistilBERT      | positive   | 1.0       | -      | -         |
| Twitter-RoBERTa | positive   | 0.72      | -      | -         |
| FinBERT         | neutral    | 0.87      | -      | -         |
| Pipeline Final  | positive   | -         | low    | reminder  |
...
| intent    | Describe la intención identificada en el mensaje: concerned, collaborative, evasive o neutral. |
...
_"Hello, I have been requesting a credit as there is a discrepancy in price, thank you."_

Los resultados obtenidos fueron los siguientes:

| Modelo          | Predicción | Confianza | Riesgo  | Acción    |
|-----------------|------------|-----------|---------|-----------|
| DistilBERT      | negative   | 0.68      | -       | -         |
| Twitter-RoBERTa | neutral    | 0.67      | -       | -         |
| FinBERT         | neutral    | 0.65      | -       | -         |
| Pipeline        | neutral    | -         | medium  |  statement|
